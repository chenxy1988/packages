...
#else
#define USL_DEBUG(fmt, args...) printf("DEBUG:" fmt "\n",##args)
#endif
...
#define TIMER_LOOP_ENABLE           1
#define TIMER_LOOP_DISABLE          0
...
extern void *usl_timer_create(unsigned int expires, unsigned int interval,
                  ...
                  usl_timer_interval_adjust_fn_t adjuster, unsigned int lf);
